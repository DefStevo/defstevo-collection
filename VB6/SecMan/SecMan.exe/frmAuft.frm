...
'Aufruf für neuen Auftrag
If Aufruf = 21 Then
  'Auftragsnummer initialisieren, Nummer wird jedoch erst beim Speichern erhöht und in Tabelle AU eingetragen
...
'Aufruf für bestehenden Auftrag
...
ElseIf Aufruf = 23 Then
    cmdVer.Visible = False
    'Angebotsnummer einfügen (Feld ANNr.visible = FALSE)
...
'Prüfen ob Auftrag bereits in Rechnungübergeleitet wurde
If Stat.Text = "Abgeschlossen" Then
    MsgBox "Aus diesem Auftrug wurde bereits eine Rechnung generiert," & vbCrLf & _
           "Nur noch Drucken möglich", vbInformation + vbOKOnly, "Auftrag bereits abgeschlossen"
    cmdZahl.Visible = False
    ArtId.Enabled = False
    Bez.Enabled = False
