package StevoSoftware.at.Hello_Android;
...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "StevoSoftware.at.Hello_Android", "main");
	...
	private void afterFirstLayout() {
		activityBA = new BA(this, layout, processBA, "StevoSoftware.at.Hello_Android", "main");
...
Debug.ShouldStop(8192);
 BA.debugLineNum = 15;BA.debugLine="If FirstTime Then";
Debug.ShouldStop(16384);
if (_firsttime) { 
 BA.debugLineNum = 16;BA.debugLine="Log(\"First Time\")";
Debug.ShouldStop(32768);
anywheresoftware.b4a.keywords.Common.Log("First Time");
 BA.debugLineNum = 17;BA.debugLine="Msgbox(\"Hello Android\", \"First Programm\")";
Debug.ShouldStop(65536);
anywheresoftware.b4a.keywords.Common.Msgbox("Hello Android","First Programm",mostCurrent.activityBA);
 }else {
 BA.debugLineNum = 19;BA.debugLine="Log(\"Not First Time\")";
Debug.ShouldStop(262144);
anywheresoftware.b4a.keywords.Common.Log("Not First Time");
 BA.debugLineNum = 20;BA.debugLine="Msgbox(\"Hello Again\", \"First Programm\")";
Debug.ShouldStop(524288);
anywheresoftware.b4a.keywords.Common.Msgbox("Hello Again","First Programm",mostCurrent.activityBA);
 };
...
public static void initializeProcessGlobals() {
    if (processGlobalsRun == false) {
		...
		try {
                if (mostCurrent != null) {
Debug.StartDebugging(mostCurrent.activityBA, 37615, new int[] {2} );}
