...
_osql.ExecNonQuery("Insert into tblSettings(Id, Name, Value) Values(0,'SMSText','???WHERE???')");
 BA.debugLineNum = 53;BA.debugLine="oSQL.ExecNonQuery(\"Insert into tblSettings(Id, Name, Value) Values(1,'SMSTo','06642154910')\")";
Debug.ShouldStop(1048576);
_osql.ExecNonQuery("Insert into tblSettings(Id, Name, Value) Values(1,'SMSTo','06642154910')");
 BA.debugLineNum = 54;BA.debugLine="oSQL.ExecNonQuery(\"Insert into tblSettings(Id, Name, Value) Values(2,'MailTo','sdehner@gmx.at')\")";
Debug.ShouldStop(2097152);
_osql.ExecNonQuery("Insert into tblSettings(Id, Name, Value) Values(2,'MailTo','sdehner@gmx.at')");
 BA.debugLineNum = 55;BA.debugLine="oSQL.ExecNonQuery(\"Insert into tblSettings(Id, Name, Value) Values(3,'SMSEnbaled','True')\")";
Debug.ShouldStop(4194304);
_osql.ExecNonQuery("Insert into tblSettings(Id, Name, Value) Values(3,'SMSEnbaled','True')");
 BA.debugLineNum = 56;BA.debugLine="oSQL.ExecNonQuery(\"Insert into tblSettings(Id, Name, Value) Values(4,'MailEnbaled','True')\")";
Debug.ShouldStop(8388608);
_osql.ExecNonQuery("Insert into tblSettings(Id, Name, Value) Values(4,'MailEnbaled','True')");
 BA.debugLineNum = 58;BA.debugLine="bDBExist = True";
...
Debug.locals.put("Query", _query);
 BA.debugLineNum = 68;BA.debugLine="Sub Execute_Non_Query(Query As String) As Boolean";
Debug.ShouldStop(8);
 BA.debugLineNum = 69;BA.debugLine="Try";
Debug.ShouldStop(16);
try { BA.debugLineNum = 70;BA.debugLine="oSQL.ExecNonQuery(Query)";
Debug.ShouldStop(32);
...
Debug.locals.put("Savepoint", _savepoint);
 BA.debugLineNum = 61;BA.debugLine="Sub Update_DB(Version As String, Savepoint As Int)";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 62;BA.debugLine="Select Case Version & \"_\" & Savepoint";
Debug.ShouldStop(536870912);
...
return "";
  ...
  public Object[] GetGlobals() {
		return new Object[] {"oSQL",_osql,"cSQL",_csql,"bDBExist",_bdbexist,"iPos",_ipos,"Main",Debug.moduleToString(StevoSoftware.at.SMS.main.class),"svSMS",Debug.moduleToString(StevoSoftware.at.SMS.svsms.class)};
}
}
