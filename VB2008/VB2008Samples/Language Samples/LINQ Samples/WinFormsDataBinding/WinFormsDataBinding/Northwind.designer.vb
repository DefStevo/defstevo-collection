...
<System.Data.Linq.Mapping.DatabaseAttribute(Name:="D:\DOCUMENTS AND SETTINGS\SOPHIAV\DESKTOP\WINFORMSDATABINDING\WINFORMSDATABINDING" & _
 "\WINFORMSDATABINDING\NORTHWND.MDF")> _
...
#Region "Extensibility Method Definitions"
    ...
    End Sub
    Partial Private Sub InsertCustomerDemographic(ByVal instance As CustomerDemographic)
    End Sub
    Partial Private Sub UpdateCustomerDemographic(ByVal instance As CustomerDemographic)
    End Sub
    Partial Private Sub DeleteCustomerDemographic(ByVal instance As CustomerDemographic)
    End Sub
    ...
    End Sub
    Partial Private Sub InsertEmployeeTerritory(ByVal instance As EmployeeTerritory)
    End Sub
    Partial Private Sub UpdateEmployeeTerritory(ByVal instance As EmployeeTerritory)
    End Sub
    Partial Private Sub DeleteEmployeeTerritory(ByVal instance As EmployeeTerritory)
    End Sub
...
#End Region
    ...
    Public Sub New()
        MyBase.New(Global.WinFormsDataBinding.My.MySettings.Default.NORTHWNDConnectionString, mappingSource)
        OnCreated()
    End Sub
