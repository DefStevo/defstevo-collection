...
#Region "Menus"
    ...
    '   private sub versteckentoolstripmenuitem_click(byval sender as system.object, byval e as system.eventargs)
    '      me.hide()
    ' end sub
    ...
    '    me.close()
    'end sub
    'private sub ausblendentoolstripmenuitem_click(byval sender as system.object, byval e as system.eventargs)
    '    me.hide()
    'end sub
    'private sub einstellungentoolstripmenuitem_click(byval sender as system.object, byval e as system.eventargs)
    '    frmeinstellungen.showdialog()
    'end sub
...
#End Region
    ...
    Private Sub mnuHaupt_ItemClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolStripItemClickedEventArgs)
